...
class FavaLedger():
    ...
    def quantize(self, value, currency=None):
        """Quantize a decimal to the right number of decimal digits.
        ...
        Returns:
            The given decimal, with the number of decimal digits adjusted.
        """
        if not currency:
