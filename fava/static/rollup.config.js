...
export default {
  ...
  plugins: [
    ...
    buble({ exclude: 'css/**' }),
    copy({
      'node_modules/codemirror/lib/codemirror.css': 'css/codemirror/lib-codemirror.css',
      'node_modules/codemirror/addon/fold/foldgutter.css': 'css/codemirror/addon-fold-foldgutter.css',
      'node_modules/codemirror/addon/dialog/dialog.css': 'css/codemirror/addon-dialog-dialog.css',
      'node_modules/codemirror/addon/hint/show-hint.css': 'css/codemirror/addon-hint-show-hint.css',
