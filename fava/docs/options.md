...
Fava currently has an English (`en`), a German (`de`), a Russian (`ru`) and a
Spanish (`es`) translation. If this setting is not specified, Fava will try to
guess the language from your browser settings.
