...
@pytest.mark.parametrize('pseudo_today,expect_start,expect_end,text', [
    ...
    ('2016-03-25', '2016-03-24', '2016-03-25', 'd-1'),
    ('2016-03-25', '2016-03-24', '2016-03-25', 'day-1'),
    ('2016-03-25', '2016-03-26', '2016-03-27', 'd+1'),
    ('2016-03-25', '2016-03-26', '2016-03-27', 'day+1'),
    ('2016-03-25', '2016-03-14', '2016-03-21', 'w-1'),
    ('2016-03-25', '2016-03-14', '2016-03-21', 'week-1'),
    ('2016-03-25', '2016-03-28', '2016-04-04', 'w+1'),
    ('2016-03-25', '2016-03-28', '2016-04-04', 'week+1'),
    ('2016-03-25', '2015-10-01', '2016-01-01', 'q-1'),
    ('2016-03-25', '2016-04-01', '2016-07-01', 'quarter+1'),
    ('2016-03-25', '2014-01-01', '2015-01-01', 'y-2'),
    ('2016-04-01', '2017-07-01', '2017-10-01', 'q+5'),
    ('2016-12-01', '2017-01-01', '2018-01-01', 'y+1'),
    ('2016-12-31', '2016-11-01', '2016-12-01', 'm-1'),
])
