...
class FavaLedger:
    ...
    def load_file(self) -> None:
        ...
        if self.use_uromyces:
            ...
            self.load_errors = ledger.errors  # type: ignore[assignment]  # ty:ignore[invalid-assignment]
        ...
        self.fava_options, self.fava_options_errors = parse_options(  # type: ignore[assignment]  # ty:ignore[invalid-assignment]
