...
Syntax: `CURRENCY1:PRECISION1,CURRENCY2:PRECISION2`

Example: `USD:2,CNY:2,JPY:0`

Set the prefered precision currency by currency. If not set, fava will use the
fractional_common value from dcontext generated by beancount. If the currency is
not found in dcontext then the a default value of 2 will be used.

Priority: precision-overwrite => dcontext fractional_common => 2

** The maxium value of precision is 14 **
